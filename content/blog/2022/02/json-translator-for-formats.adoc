...
:jbake-tags: JSON,antlr,AST,抽象语法树,代码生成,Thrift,Protobuf,编程语言
:idprefix:
...
JSON是一个数据，从[.underline]##https://www.json.org/json-en.html[JSON.org]## 能知道它只有以下数据：
...
[#attributes-tree]
.属性树
image::images/attributes-tree.svg[属性树]
