...
image::images/exp-tree.png[表达式树]

=== 表达式求值

拿到表达式树之后，我们可用深度优先遍历(Depth First)的方式遍历这棵树，并在遍历的过程中收集变量，并根据其操作觉得该变量的值，使得表达式求值结果为真。
...
* Stackoverflow, Lasse V. Karlsen, https://stackoverflow.com/a/423905/521996
