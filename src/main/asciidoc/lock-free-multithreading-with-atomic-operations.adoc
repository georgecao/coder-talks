...
.Multiple layers of a computer program. Dashed lines are software, solid lines are hardware.
...
.Hierarchy of atomic instructions and operations. Dashed lines are software, solid lines are hardware.
